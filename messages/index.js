...
module.exports = {
  ...
  maxItems: {
    ...
    fa: '{{#def.n}}نباید بیشتر از {{=n}} مورد باشد',
  ...
  minItems: {
    ...
    fa: '{{#def.n}}نباید کمتر از {{=n}} مورد باشد',
  ...
  maxLength: {
    ...
    fa: '{{#def.n}}نباید بیشتر از {{=n}} حرف باشد',
  ...
  minLength: {
    ...
    fa: '{{#def.n}}نباید کمتر از {{=n}} حرف باشد',
  ...
  type: {
    ...
    fa: '{{#def.t}}فیلد باید {{? t == "number" }}عدد{{?? t == "integer"}}عددصحیح{{?? t == "string"}}رشته{{?? t == "boolean"}}بولین{{?? t == "object"}}شی{{??}}{{=t}}{{?}} باشد',
